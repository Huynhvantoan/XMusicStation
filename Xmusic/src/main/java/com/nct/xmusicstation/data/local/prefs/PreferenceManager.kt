...
object PreferenceHelper{
     ...
     */
    fun initialize(application: Application, sharedPreferencesName: String): PreferenceHelper {
...
inline fun pref(sharedPreferences: PreferenceHelper.() -> Unit) = with(PreferenceHelper) {
    also {
        sharedPreferences()
        apply()
    }
